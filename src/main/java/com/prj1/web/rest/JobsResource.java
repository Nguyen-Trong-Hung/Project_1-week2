...
/**
 * REST controller for managing {@link com.prj1.domain.Jobs}.
 */
@RestController
...
public class JobsResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<JobsDTO>> getAllJobs(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<JobsDTO> getJobs(@PathVariable("id") Long id) {
