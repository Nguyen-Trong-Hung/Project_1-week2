...
export const JobsDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/jobs' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="project1Week2App.jobs.delete.question">
        <Translate contentKey="project1Week2App.jobs.delete.question" interpolate={{ id: jobsEntity.id }}>
