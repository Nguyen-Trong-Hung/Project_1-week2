  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="project1Week2App.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="project1Week2App.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('project1Week2App.category.name')}
                id="category-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('project1Week2App.category.createdBy')}
              ...
              />
              <ValidatedField
                label={translate('project1Week2App.category.createdDate')}
              ...
              />
              <ValidatedField
                label={translate('project1Week2App.category.updateDate')}
              ...
              />
              <ValidatedField
                label={translate('project1Week2App.category.updateBy')}
