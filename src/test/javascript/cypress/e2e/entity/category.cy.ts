...
describe('Category e2e test', () => {
  ...
  const categorySample = { name: 'attic yippee whereas' };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="name"]`).type('onto lest');
      cy.get(`[data-cy="name"]`).should('have.value', 'onto lest');

      cy.get(`[data-cy="createdBy"]`).type('13679');
      cy.get(`[data-cy="createdBy"]`).should('have.value', '13679');

      cy.get(`[data-cy="createdDate"]`).type('2023-12-24T01:34');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2023-12-24T01:34');

      cy.get(`[data-cy="updateDate"]`).type('2023-12-24T09:51');
      cy.get(`[data-cy="updateDate"]`).blur();
      cy.get(`[data-cy="updateDate"]`).should('have.value', '2023-12-24T09:51');

      cy.get(`[data-cy="updateBy"]`).type('25893');
      cy.get(`[data-cy="updateBy"]`).should('have.value', '25893');
